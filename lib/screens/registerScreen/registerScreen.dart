          ...
          Stack(children: [
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  fit: BoxFit.cover,
                  image: active ? AssetImage('assets/images/backgrounds/BPS.jpg') : AssetImage('assets/images/backgrounds/BPT.jpg')
                )
              )
            ),
            Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                alignment: Alignment.center,
                                child: AutoSizeText(
                                  active ? 'Student Registration' : 'Teacher Registration',
                                  maxLines: 1,
                                  style: TextStyle(
                                    fontSize: 20.0,
                                    letterSpacing: -0.5,
